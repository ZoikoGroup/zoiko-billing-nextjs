...
interface DocRouteIntentItem {
  label: string;
  target: string;
  href: string;
}

const docRouteIntents: DocRouteIntentItem[] = [
  { label: "Understand the model", target: "Concepts · Catalog", href: "#concepts" },
  { label: "Review access", target: "Authentication", href: "#authentication" },
  { label: "Handle async change", target: "Webhooks", href: "#webhooks" },
  { label: "Test safely", target: "Developer Sandbox", href: "#sandbox" },
  { label: "Plan production", target: "Build an Integration", href: "#build-integration" },
];

export default function DeveloperDocFinalCtaSection() {
  return (
    <section className="w-full bg-white py-10 lg:py-16" id="final-cta">
      <div className="mx-auto max-w-[1320px] px-4 sm:px-8 lg:px-12 flex flex-col gap-10">
        ...
        <div className="hidden lg:flex relative overflow-hidden rounded-[28px] bg-[#0A132C] p-10 lg:p-14 shadow-2xl border border-slate-800/80 flex-row items-center justify-between gap-10">
          ...
          <div className="relative z-10 flex flex-col items-start gap-4 max-w-xl text-left">
            <h2 className="text-3xl font-extrabold leading-[1.18] tracking-tight text-white sm:text-4xl lg:text-[38px]">
              Ready to turn the reference <br />
              into an integration?
            </h2>

            <p className="text-sm font-normal leading-relaxed text-slate-400 sm:text-base max-w-[460px] mt-1">
              Use the documentation to validate your resource contracts, then continue through
              access, testing, implementation and launch using the approved developer path.
            </p>
          ...
          <div className="relative z-10 w-full max-w-[540px] shrink-0">
            <img
              src="/images/devoloper-api-documentation/dad6.png"
              alt="Ready to turn the reference into an integration"
        ...
        {/* ========================================================================= */}
        {/* MOBILE VERSION (MATCHING REFERENCE media_1787661723638.png - block lg:hidden) */}
        {/* ========================================================================= */}
        <div className="block lg:hidden relative overflow-hidden rounded-[24px] bg-[#0A132C] p-6 sm:p-8 shadow-xl border border-slate-800 text-left">
          ...
          <p className="text-xs font-normal leading-relaxed text-slate-400 mb-5 relative z-10">
            Use the documentation to validate your resource contracts, then continue through access, testing, implementation and launch using the approved developer path.
          </p>
        ...
        <div className="block lg:hidden relative overflow-hidden rounded-2xl sm:rounded-3xl bg-gradient-to-r from-[#1D60EB] via-[#2A52D8] to-[#4339C7] p-7 sm:p-12 text-left text-white shadow-xl">
          ...
          <h2 className="text-2xl sm:text-3xl font-extrabold leading-tight tracking-tight text-white mb-3">
            Inspectable contracts, not implied behavior.
          </h2>

          <p className="text-xs sm:text-sm text-blue-100/90 font-normal leading-relaxed max-w-lg mb-6 sm:mb-8">
            Availability, exposure, permissions, lifecycle and evidence impact stated per operation — and sourced, never assumed.
          </p>
          ...
          <div className="flex flex-wrap items-center gap-3.5 mb-6 sm:mb-8">
            ...
            >
              <span className="text-[#1D60EB] font-semibold">Open the reference</span>
            </Link>
            ...
            >
              <span className="text-white font-semibold">Resource catalog</span>
            </Link>
          </div>
