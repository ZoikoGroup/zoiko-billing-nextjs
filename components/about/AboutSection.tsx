...
export default function AboutSection() {
  ...
  return (
    <section
      id="overview"
      className="w-full overflow-hidden bg-white px-4 py-16 font-['Segoe_UI',sans-serif] transition-colors duration-200 dark:bg-slate-950 sm:px-8 lg:px-12 lg:py-24"
    >
      <div className="mx-auto grid w-full max-w-[1220px] grid-cols-1 items-center gap-12 lg:grid-cols-12 lg:gap-16">
        ...
        <div className="flex max-w-[530px] flex-col items-start justify-start gap-5 lg:col-span-6">
          ...
          <p className="text-base leading-8 text-slate-600 dark:text-slate-300">
            ...
            businesses turn commercial activity into accurate invoices,
            recorded payments, resolved balances, and clear financial records.
            Use it independently or connect it with Zoiko One as your
            organization grows.
          </p>
          ...
          <div className="flex w-full flex-col flex-wrap gap-4 pt-2 sm:flex-row sm:items-center">
            <Link
              ...
              className="inline-flex min-h-11 cursor-pointer items-center justify-center rounded-lg border border-blue-600 bg-blue-600 px-5 py-2.5 text-center text-base font-normal leading-6 text-white shadow-xs transition-colors hover:bg-blue-500"
            >
            ...
            <Link
              href="/book-demo"
              className="inline-flex min-h-11 cursor-pointer items-center justify-center rounded-lg border border-zinc-200 px-5 py-2.5 text-center text-base font-normal leading-6 text-sky-950 transition-colors hover:bg-slate-50 dark:border-slate-700 dark:text-slate-100 dark:hover:bg-slate-800"
            >
              Book a Demo
            </Link>
          </div>

          {/* Global Capabilities Link */}
          <Link
            href="/global-billing"
