  ...
  return (
    <section className="w-full bg-[#091127]">
      ...
      >
        <div
          className="
            flex w-full max-w-[1240px] flex-col items-center
            gap-6 px-0
            sm:px-4
            lg:px-7
          "
        >
          ...
          >
            ...
            <h2
              ...
              "
            >
              Never silently redefine an industry term.
            </h2>
            ...
            <p
              ...
              "
            >
              Six scenarios where one confident definition would be wrong for
              some readers in a way they could not detect.
            </p>
          </div>

          {/* IMAGE */}
          <div className="w-full overflow-hidden rounded-2xl border border-white/10 shadow-[0_8px_24px_rgba(15,23,42,0.05),0_1px_2px_rgba(15,23,42,0.04)]">
            <img
              src="/images/billing-glossary/ambiguity.png"
              alt="Ambiguity and disambiguation examples"
              className="
                block h-auto w-full
                object-cover
              "
