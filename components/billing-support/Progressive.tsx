        ...
        >
          ...
          >
            ...
            <h2
              ...
              "
            >
              Four steps, collecting only what the
              selected topic requires.
            </h2>
            ...
            <p
              ...
              "
            >
              Fields marked conditional appear only when the topic genuinely
              needs them — a request about a billing detail does not ask for
              an amount.
            </p>
          </div>
          ...
          <div className="w-full overflow-hidden rounded-2xl">
            <img
              src="/images/billing-support/progressive.png"
              alt="Progressive billing support intake"
              className="
