  ...
  return (
    <section className="integrations-section" id="resources">
      <div className="section-shell integrations-panel">
        ...
        <div className="integrations-demo-image"><Image src="/images/integrations/frame-3.png" alt="Connected billing integrations" fill sizes="(max-width: 800px) 100vw, 1200px" /></div>
