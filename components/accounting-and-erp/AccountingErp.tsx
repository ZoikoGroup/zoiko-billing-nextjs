    ...
    <section className="w-full overflow-hidden bg-white">
      ...
      >
        ...
        <div className="w-full min-w-0 lg:w-[52%]">
          ...
          >
            ...
            <span className="text-blue-600">
              without blurring which system owns the books.
            </span>
          </h2>
          ...
          <p
            ...
            "
          >
            Evaluate registry-backed connections by supported billing objects,
            actions, direction, mapping requirements, authentication, regions
            and plans, target acknowledgment semantics, operational status,
            documentation and last verification.
          </p>
        ...
        >
          ...
          >
            <Image
              src="/images/accounting-and-erp/erp.png"
              alt="Accounting and ERP integrations"
              fill
              priority
