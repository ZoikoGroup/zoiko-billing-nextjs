  ...
  const rows = [
    {
      ...
      treatment: (
        <>
          Not routed here{" "}
          <strong>unless the issue is a Zoiko account charge</strong>
        </>
      ),
    },
    {
    ...
    },
    {
      ...
      authority: <strong>Billing Support</strong>,
      treatment:
    ...
    },
    {
      ...
      authority: <span className="font-semibold text-[#4f6f9f]">Pricing</span>,
      treatment: (
        <>
          May help with an account-specific commercial issue, but{" "}
          <strong>publishes no pricing truth</strong>
        </>
      ),
    },
    {
      ...
      authority: (
        <span className="font-semibold text-[#4f6f9f]">
          Account Access
        </span>
      ),
      treatment: (
        <>
          ...
          <strong>Billing Support does not bypass identity controls</strong>
        </>
      ),
    },
    {
    ...
    },
    {
      ...
      treatment: (
        <>
          Current service state stays in Status; charge review may follow only
          if applicable
        </>
      ),
    },
        ...
        >
          ...
          >
            ...
            <h2
              ...
              "
            >
              Eight intents, and only one belongs here.
            </h2>
          ...
          >
            ...
            <div className="hidden md:block">
              ...
              <div
                className="
                  grid
                  grid-cols-[minmax(0,1.05fr)_minmax(0,0.6fr)_minmax(0,1.5fr)]
                  bg-[#fafbfc]
                "
              >
