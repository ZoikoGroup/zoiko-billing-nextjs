        ...
        >
          ...
          >
            ...
            <h2
              ...
              "
            >
              Nine requirements, including one that
              protects password managers.
            </h2>
            ...
            <p
              ...
              "
            >
              Accessibility and security requirements here are release-blocking,
              not preferences.
            </p>
          </div>
          ...
          <div className="w-full overflow-hidden rounded-2xl border border-[#dfe5ee] bg-white shadow-[0_8px_24px_rgba(15,23,42,0.05),0_1px_2px_rgba(15,23,42,0.04)]">
            <img
              src="/images/account-access/form-input.png"
              alt="Form and input contract"
              className="
                block h-auto w-full
                object-cover
              "
