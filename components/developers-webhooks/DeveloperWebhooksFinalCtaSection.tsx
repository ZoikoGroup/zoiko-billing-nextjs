...
interface WebhookStageRouteItem {
  stage: string;
  target: string;
  href: string;
}

const webhookStageRoutes: WebhookStageRouteItem[] = [
  { stage: "Discovery", target: "Event catalog", href: "#event-catalog" },
  { stage: "Evaluation", target: "Verification · Delivery contract", href: "#verification-security" },
  { stage: "Activation", target: "Endpoint setup · Testing", href: "#endpoint-setup" },
  { stage: "Implementation", target: "Retries · Duplicates · Ordering", href: "#failures-retries" },
  { stage: "Production", target: "Delivery logs · Change notices", href: "#attempt-evidence" },
];

export default function DeveloperWebhooksFinalCtaSection() {
  return (
    <section className="w-full bg-white py-10 lg:py-16" id="final-cta">
      <div className="mx-auto max-w-[1320px] px-4 sm:px-8 lg:px-12 flex flex-col gap-10">
        ...
        <div className="hidden lg:flex relative overflow-hidden rounded-[28px] bg-[#0A132C] p-10 lg:p-14 shadow-2xl border border-slate-800/80 flex-row items-center justify-between gap-10">
          ...
          <div className="relative z-10 flex flex-col items-start gap-4 max-w-xl text-left">
            <h2 className="text-3xl font-extrabold leading-[1.18] tracking-tight text-white sm:text-4xl lg:text-[38px]">
              Operate the integration, <br />
              not just build it.
            </h2>

            <p className="text-sm font-normal leading-relaxed text-slate-400 sm:text-base max-w-[460px] mt-1">
              Verification, delivery evidence, failure categories and change notices are what
              keep a webhook consumer working after launch.
            </p>
            ...
            <div className="flex flex-wrap items-center gap-3.5 pt-3">
              ...
              >
                <span className="text-slate-900 font-semibold">View delivery model</span>
              </Link>
          ...
          {/* Right Side Image Container dw9.png */}
          <div className="relative z-10 w-full max-w-[540px] shrink-0">
            <img
              src="/images/devolpers-webhooks/dw9.png"
              alt="Operate the integration, not just build it"
        ...
        {/* ========================================================================= */}
        {/* MOBILE VERSION (MATCHING REFERENCE media_1787665947761.png - block lg:hidden) */}
        {/* ========================================================================= */}
        <div className="block lg:hidden relative overflow-hidden rounded-[24px] bg-[#0A132C] p-6 sm:p-8 shadow-xl border border-slate-800 text-left">
          ...
          <p className="text-xs font-normal leading-relaxed text-slate-400 mb-5 relative z-10">
            Verification, delivery evidence, failure categories and change notices are what keep a webhook consumer working after launch.
          </p>
          ...
          <div className="rounded-2xl bg-[#070D1E]/70 border border-slate-800 p-4 sm:p-5 relative z-10 text-xs text-slate-300">
            ...
            <div className="divide-y divide-slate-800/80">
              {webhookStageRoutes.map((item, idx) => (
                <div key={idx} className="py-2.5 flex items-center justify-between gap-3">
                  <span className="text-slate-400 text-xs font-normal">{item.stage}</span>
        ...
        <div className="block lg:hidden relative overflow-hidden rounded-2xl sm:rounded-3xl bg-gradient-to-r from-[#1D60EB] via-[#2A52D8] to-[#4339C7] p-7 sm:p-12 text-left text-white shadow-xl">
          ...
          <div className="flex flex-wrap items-center gap-3.5 mb-6 sm:mb-8">
            ...
            >
              <span className="text-[#1D60EB] font-semibold">Inspect delivery evidence</span>
            </Link>

            <Link
              href="#delivery-contract"
            ...
            >
              <span className="text-white font-semibold">Delivery contract</span>
            </Link>
          </div>
