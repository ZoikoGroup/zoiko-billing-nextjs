...
const correctionPaths = [
  ...
  },
  {
    ...
    direction:
      "Prepare a credit note or supported legal correction.",
    control:
  ...
  },
  {
    ...
    control:
      "Recipient permission, delivery evidence and privacy review.",
  },
  {
...
const creditStates = [
  ...
  },
  {
    ...
    tone: "info",
    meaning:
      "The version may proceed according to configuration.",
  ...
  },
  {
    ...
    tone: "success",
    meaning:
      "The credit affects a document or balance relationship.",
    evidence:
  ...
  },
  {
    ...
    tone: "neutral",
    meaning:
      "A supported exceptional state ends further use.",
    evidence:
  ...
  },
  {
    ...
    tone: "error",
    meaning:
      "The document or its transport did not complete.",
    evidence:
      "Retry or manual recovery without duplicate issue.",
  },
];
      ...
      >
        ...
        >
          ...
          <div
            ...
            "
          >
            {correctionTypes.map((item, index) => (
              <div
                key={item.title}
                className={`
                  flex
                  ...
                  p-5
                  ${
                    index !== correctionTypes.length - 1
