  ...
  return (
    <section className="w-full border-t border-gray-200 bg-gray-50">
      <div className="mx-auto flex w-full max-w-[1320px] flex-col items-start gap-3.5 px-6 py-12 sm:px-8 sm:py-14 lg:px-7 lg:py-16">
        ...
        {/* Heading */}
        <h2 className="!m-0 w-full max-w-[950px] !text-[30px] !font-extrabold !leading-[1.15] tracking-tight text-gray-900">
          Across the portfolio, every item names its client, basis, reason and
          owner.
        </h2>
