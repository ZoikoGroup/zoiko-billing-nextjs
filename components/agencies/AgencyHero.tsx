      ...
      >
        ...
        <div className="w-full min-w-0 lg:w-[52%]">
          ...
          <h1
            ...
            "
          >
            Keep client billing clear from approved fee to outstanding
            balance.
          </h1>
          ...
          <h1
            ...
            "
          >
            <span className="block">Keep client billing clear</span>
            <span className="block">from approved fee to</span>
            <span className="block">outstanding balance.</span>
          </h1>
