    ...
    <section className="w-full overflow-hidden bg-white">
      ...
      >
        ...
        <div className="w-full min-w-0 lg:w-[52%]">
          ...
          >
            ...
            <span className="!text-[#1F6FEB]">
              Here is how to report it safely.
            </span>
          </h1>
          ...
          <h1
            ...
            "
          >
            <span className="block">Found a security issue?</span>

            <span className="block !text-[#1F6FEB]">
              Here is how to report it
            </span>

            <span className="block !text-[#1F6FEB]">safely.</span>
          </h1>
          ...
          <p
            ...
            "
          >
            Read the testing rules and scope before you test, keep evidence
            minimal, and use the approved secure route. This page explains what
            we ask of researchers and what happens after a report arrives.
          </p>
          ...
          >
            ...
            <Link
              ...
              "
            >
              Review scope and testing rules
            </Link>
          </div>
        ...
        >
          ...
          >
            <Image
              src="/images/responsible-disclosure/responsible-disclosure-hero.png"
              alt="Reporting a security issue to Zoiko Billing"
              fill
              priority
