        ...
        >
          ...
          >
            ...
            <h2
              ...
              "
            >
              Eight ways this page can fail, and how each resolves.
            </h2>
            ...
            <p
              ...
              "
            >
              A status page that breaks during an incident is failing at
              precisely the moment it matters, so its own failure modes are
          ...
          <div className="w-full">
            <img
              src="/images/system-status/failure-states.png"
              alt="Failure and edge states"
              className="
